...
- (void)setupSubViews
{
    ...
    [self.inputButton setTitle:[@"ChatPlaceholderText" ag_localized] forState:UIControlStateNormal] ;
...
{
    if(self.isAllMuted) {
        [self.inputButton setTitle:[@"ChatAllMute" ag_localized] forState:UIControlStateNormal];
        [self.inputButton setEnabled:NO];
        self.emojiButton.enabled = NO;
        
    }else{
        if(self.isMuted){
            [self.inputButton setTitle:[@"ChatMute" ag_localized] forState:UIControlStateNormal];
            [self.inputButton setEnabled:NO];
            self.emojiButton.enabled = NO;
        }else{
            [self.inputButton setTitle:[@"ChatPlaceholderText" ag_localized] forState:UIControlStateNormal];
